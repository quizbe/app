...
<div class="p-4 min-h-[calc(100vh-var(--spacing)*18)] grid">
	<div class="container mx-auto flex flex-col justify-center items-center gap-4 h-full">
		...
		<div
			class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4 w-full"
		>
